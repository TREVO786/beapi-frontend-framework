...
// get_lorem(20, 30) -> print and return a string between 20 and 30 chars
// get_lorem(20, 30, false) -> return a string between 20 and 30 chars
// get_lorem(50, 60, '<p>', '</p>') -> print and return a string between 20 and 30 chars wrapped in <p> tag
// get_lorem(50, 60, '<p>', '</p>', 7) -> print and return 7 string between 20 and 30 chars wrapped in <p> tag
// get_lorem(50, 60, false, '<p>', '</p>', 7) -> return 7 string between 20 and 30 chars wrapped in <p> tag
function get_lorem($min = 0, $max = INF, $print = true, $wrapBefore = '', $wrapAfter = '', $nbGet = 1) {
    ...
    for ($i = 0; $i < $nbGet; $i++) {
        ...
        $result .= $wrapBefore.ucfirst(trim(substr($lorem, $rnd, rand($min, $max)))).'.'.$wrapAfter;
    }
    if ($print) {
        print $result;
    }
